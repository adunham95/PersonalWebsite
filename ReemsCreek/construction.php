...
<body>
    ...
    <div class='container'>
        <div class="jumbotron centered yellow darken-2">
  <h1>This is not quite ready</h1>
  <p><a class="btn btn-primary btn-lg" href="index.php" role="button">Go Home</a></p>
</div>
    </div>
